...
public class Level2 extends Levels {
    ...
    public Level2(Main main, SpriteBatch spriteBatch) {
        ...
        Gdx.input.setInputProcessor(new Level2.SlingShotInputProcessor());
    ...
    private void handleCollision(GameObject bird, GameObject target) {
        ...
        if (!isWood && !isStone && !isGlass && !isTNT && !isKingPig && !isPig1 && !isPig2) {
            ...
            WinningScreen winningScreen = new WinningScreen(main, new Level2(main, spriteBatch));
        ...
        if (Gdx.input.isButtonJustPressed(Input.Buttons.LEFT)) {
            ...
            if (mouseX >= pauseX && mouseX <= pauseX + 50 && mouseY >= pauseY && mouseY <= pauseY + 50) {
                ...
                if (isPaused) {
                    ...
                    Pause pauseMenu = new Pause(main, spriteBatch, new Level2(main, spriteBatch));
