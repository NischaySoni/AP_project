...
//        Texture groundTexture = new Texture("ground1.png");
//
...
public class Ground {
    ...
    public Ground(World world) {
        Texture groundTexture = new Texture("ground1.jpg");
        ...
        // Create the shape of the ground (a simple rectangle covering the screen width)
        PolygonShape groundShape = new PolygonShape();
        groundShape.setAsBox(Gdx.graphics.getWidth() / 2f, Gdx.graphics.getWidth() / 8f);  // Width = screen width / 2, Height = screen width / 4
        ...
        // Create a sprite to render the ground texture
        groundSprite = new Sprite(groundTexture);
        groundSprite.setSize(Gdx.graphics.getWidth(), Gdx.graphics.getWidth() / 4f);  // Set the sprite size (full screen width, 1/4th of the width for height)
        groundSprite.setPosition(0, 10f);  // Position the sprite at the bottom-left corner
    }
