...
public class Pig2 extends GameObject {
    private float x, y, width, height;
    private int health;
    private Object texture;

    public Pig2(float x, float y, float width, float height, int health, String name, Object Pig2Texture) {
    ...
    public void takeDamage() {
        health--;
        if (health <= 0) {
            System.out.println("Pig2 is destroyed!");
    ...
    private void removeWoodTexture() {
        if (texture != null) {
            System.out.println("Removing Pig2 texture.");
            texture = null;
        }
    }
